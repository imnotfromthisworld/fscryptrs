    ...
    Self: DigestHandler<D>,
{
    ...
    fn write(&mut self, mut buf: &[u8]) -> std::io::Result<usize> {
        ...
        let phys_size = self.file.metadata().unwrap().len();
    ...
    mod enc_write {
        ...
        macro_rules! test_enc_write {
            ($filename:ident, $outdir:expr_2021) => {
                ...
                #[test]
                #[serial]
                fn $filename() -> Result<(), CryptoError> {
                    ...
                    let path = TEST_ROOT.to_owned()
                        ...
                        + "/test_enc_write_"
                        + stringify!($filename);
                    let path_digest = path.clone() + ".digest";
                    {
                    ...
                    println!("buffer length={}", buf2.len());
        ...
        mod block {
            ...
            const TEST_ROOT: &str = "./data/tests/";
            const TEST_OUTPUT: &str = "./data/tests/block/";
            ...
            #[test]
            fn file_range_0_1_m() -> Result<(), CryptoError> {
                let range = Uniform::try_from(0..255).unwrap();
        ...
        mod stream {
            ...
            const TEST_ROOT: &str = "./data/tests/";
            const TEST_OUTPUT: &str = "./data/tests/stream/";
