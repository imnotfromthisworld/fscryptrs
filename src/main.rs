...
impl Cli {
    fn prompt_password() -> String {
        loop {
            let pw =
                rpassword::prompt_password("Please enter password used for encryption: ").unwrap();
            let pw2 = rpassword::prompt_password("Retype the password: ").unwrap();
...
fn main() -> Result<()> {
    ...
    match args.command {
        Commands::Init {
            ...
            let pw = pw.unwrap_or_else(Cli::prompt_password);
